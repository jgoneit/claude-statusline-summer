...
5h·7d 행에는 리셋까지 남은 시간(`resets 2h13m`)도 표시됩니다.
...
| `$0.21` | 세션 비용 |
| `9m 30s` | 경과 시간 |
| `5h  ██████░░░░ 58% · resets 2h13m` | 5시간 rate limit **사용량** + 리셋까지 남은 시간 — Pro/Max |
| `7d  ████░░░░░░ 40% · resets 3d5h` | 7일 rate limit **사용량** + 리셋까지 남은 시간 — Pro/Max |
...
| `$0.21` | Session cost |
| `9m 30s` | Elapsed time |
| `5h  ██████░░░░ 58% · resets 2h13m` | 5-hour rate limit **usage** + time until reset — Pro/Max |
| `7d  ████░░░░░░ 40% · resets 3d5h` | 7-day rate limit **usage** + time until reset — Pro/Max |
